...
CREATE TABLE `users` (
  ...
  CONSTRAINT `user_id` FOREIGN KEY (`userID`) REFERENCES `employees` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `users` VALUES (102,'gowtham','emp102'),(1,'admin','laksh_29'),(106,'Priya','priya12'),(109,'rajayiii','emp109');
